...
function get_weather_formspec(p_name, section)
  ...
  local formspec = {
    ...
    "container[1,1]",
    "image_button[0,0;1,1;arenalib_weather_rain.png" .. (section ~= "rain" and "^[multiply:#aaaaaa" or "") .. ";rain_btn;]",
    "image_button[1.6,0;1,1;arenalib_weather_snow.png" .. (section ~= "snow" and "^[multiply:#aaaaaa" or "") .. ";snow_btn;]",
    "image_button[3.2,0;1,1;arenalib_weather_dust.png" .. (section ~= "dust" and "^[multiply:#aaaaaa" or "") .. ";dust_btn;]",
    "container_end[]",
    "container[1,1.8]",
